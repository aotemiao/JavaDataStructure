...
public class ByStackBinaryTree_prelist
{
...
//        String[] prelist = BinaryTreeLists.prelists[0];
        ByStackBinaryTree<String> bitree = new ByStackBinaryTree(prelist);
        ByStackBinaryTree<String> bitree2 = new ByStackBinaryTree(bitree);
